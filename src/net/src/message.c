                         ...
                         size_t                    len)
{
    ...
    BE_EXTRACT_FROM_BUFFER(buf, req->type, 16);
    BE_EXTRACT_FROM_BUFFER(buf, req->command, 16);
                          ...
                          size_t                     len)
{
    ...
    BE_EXTRACT_FROM_BUFFER(buf, resp->type, 16);
